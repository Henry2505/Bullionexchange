...
const SUPABASE_ANON = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRhcHdwZ3ZuZmpjZnFxaHJweGxhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDcwNDA4ODgsImV4cCI6MjA2MjYxNjg4OH0.ICC0UsLlzJDNre7rFCeD3k6iVzo6jOJgn3PhABpEMsQ'
export const supabase = createClient(SUPABASE_URL, SUPABASE_ANON)

// … sidebar & nav code above …
...
window.addEventListener('DOMContentLoaded', () => {
  loadPayments()
  loadMembers()
  // …and later: loadMessages(), loadTestimonials(), etc.
})
